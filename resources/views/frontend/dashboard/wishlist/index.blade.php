 <div class="tab-pane fade" id="wishlist-tab" role="tabpanel" aria-labelledby="wishlist-detail-tab">
     <div class="card">
         <div class="card-header p-0">
            <h4>{{ __('messages.wishlist_title') }}</h4>
         </div>
                 ...
                 <table class="table table-wishlist mb-0">
                     <thead>
                         <tr class="main-heading">
                             ...
                             <th scope="col">{{ __('messages.stock_status') }}</th>
                             <th scope="col">{{ __('messages.action') }}</th>
                             <th scope="col" class="end">{{ __('messages.remove') }}</th>
                         </tr>
                     </thead>
                     <tbody>
                         <tr class="pt-30">
                             ...
                             <td class="text-center detail-info" data-title="Stock">
                                 <span class="stock-status in-stock mb-0"> {{ __('messages.in_stock') }}
                                 </span>
                             </td>
                             <td class="text-right" data-title="Cart">
                                 <button class="btn btn-sm">{{ __('messages.add_to_cart') }}</button>
                             </td>
                         ...
                         <tr>
                             ...
                             <td class="text-center detail-info" data-title="Stock">
                                 <span class="stock-status out-stock mb-0"> {{ __('messages.out_stock') }}
                                 </span>
                             </td>
                             <td class="text-right" data-title="Cart">
                                 <button class="btn btn-sm btn-secondary">{{ __('messages.contact_us') }}</button>
                             </td>
                             <td class="action text-center" data-title="Remove">
                                 <a href="#" class="text-body"><i class="fi-rs-trash"></i></a>
                             </td>
